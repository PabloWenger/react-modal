...
export default class ModalTest2 extends Modal {
    ...
    constructor(props){
        ...
        this.openModalTest1 = this.openModalTest1.bind(this);
    }
    ...
    openModalTest1(){
        let prop1 = 100;
        let prop2 = 200;
        super.openModal(<ModalTest1 prop1={prop1} prop2={prop2}></ModalTest1>);
    }
    ...
    render(){
        return (
            <Modal size="small">
                ...
                <ModalBody>
                    <button onClick={this.openModalTest1}>Open Modal Test 1</button>
                    <br></br>
                    <br></br>
                    <br></br>
                    <br></br>
                ...
                <ModalFooter>
                    <strong>Modal Test 2 Footer</strong>
                    <button onClick={this.closeThisModal}>Close Modal Test 2</button>
                </ModalFooter>
            </Modal>
        );
    }
